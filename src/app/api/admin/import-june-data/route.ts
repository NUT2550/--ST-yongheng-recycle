...
const MANUAL_MAP: Record<string, string> = {
  ...
  'อลูมิเneียมกระป๋อง': 'กระป๋องอลูมีเneียม',
  'อลูมิเneียมล้อแม็ค': 'อลูมีเneียมล้อแม๊กซ์',
  'อลูมิเneียมแข็ง': 'อลูมีเneียมแข็ง',
  'อลูมิเneียมตูดกะทะ': 'อลูมีเneียมตูดกะทะ',
  'อลูมิเneียมฝาแกะ': 'ฝาอลูมีเneียมเneียม',
  'อลูมิเneียมติดเหล็ก': 'อลูมิเneียมติดเหล็ก',
  'อลูมิเneียมมุ้งลวด': 'อลูมีเneียมมุ้งลวด',
  'อลูมิเneียมหล่อ': 'อลูมีเneียมแข็ง',
  'สายไฟอลูมีเneียม(ไม่ปอก)': 'สายไฟอลูมีเneียม(ไม่ปอก)',
  'อลูมิเneียมอัลลอยด์': 'อลูมีเneียมอัลลอย',
  'อลูมิเneียมมู่ลี่': 'อลูมีเneียมมู่ลี่',
  'หนาติดสี': 'หนาติดสี',
};
  ...
  try {
    ...
    const BUY_DATA: Array<{
    ...
    }> = [
      {
        ...
        items: [
          ...
          { code: '0201', name: 'อลูมิเneียมกระป๋อง', weight: 379.6, totalAmount: 32326.9, avgPrice: 85.16 },
          { code: '0202', name: 'อลูมิเneียมล้อแม็ค', weight: 66.2, totalAmount: 6329.8, avgPrice: 95.62 },
          { code: '0203', name: 'อลูมิเneียมสายไฟ', weight: 2.8, totalAmount: 305, avgPrice: 108.93 },
          { code: '0204', name: 'อลูมิเneียมบาง', weight: 613.6, totalAmount: 46269.1, avgPrice: 75.41 },
          { code: '0205', name: 'อลูมิเneียมแข็ง', weight: 210.8, totalAmount: 16474.7, avgPrice: 78.15 },
          { code: '0210', name: 'อลูมิเneียมตูดกะทะ', weight: 52.2, totalAmount: 2873.9, avgPrice: 55.06 },
          { code: '0213', name: 'อลูมิเneียมฝาแกะ', weight: 5.2, totalAmount: 321.8, avgPrice: 61.88 },
          { code: '0215', name: 'อลูมิเneียมฉาก', weight: 49, totalAmount: 4963.6, avgPrice: 101.3 },
          { code: '0216', name: 'หม้อน้ำอลูมีเneียม', weight: 25.3, totalAmount: 1563.2, avgPrice: 61.79 },
          { code: '0218', name: 'อลูมีเneียมครีบหม้อน้ำ', weight: 1.4, totalAmount: 47.6, avgPrice: 34 },
          { code: '0227', name: 'อลูมิเneียมติดเหล็ก', weight: 21, totalAmount: 1554, avgPrice: 74 },
          { code: '0231', name: 'อลูมิเneียมฉากสี', weight: 17.9, totalAmount: 1683.6, avgPrice: 94.06 },
      ...
      },
      {
        ...
        items: [
          ...
          { code: '0204', name: 'อลูมิเneียมบาง', weight: 18.5, totalAmount: 1313.5, avgPrice: 71 },
          { code: '0205', name: 'อลูมิเneียมแข็ง', weight: 7.7, totalAmount: 585.2, avgPrice: 76 },
          { code: '0210', name: 'อลูมิเneียมตูดกะทะ', weight: 1.6, totalAmount: 81.6, avgPrice: 51 },
      ...
      },
      {
        ...
        items: [
          ...
          { code: '0203', name: 'อลูมิเneียมสายไฟ', weight: 0.3, totalAmount: 31.5, avgPrice: 105 },
          { code: '0204', name: 'อลูมิเneียมบาง', weight: 22, totalAmount: 1595, avgPrice: 72.5 },
          { code: '0205', name: 'อลูมิเneียมแข็ง', weight: 38, totalAmount: 2888, avgPrice: 76 },
          { code: '0211', name: 'อลูมิเneียมมุ้งลวด', weight: 0.2, totalAmount: 3.4, avgPrice: 17 },
      ...
      },
      {
        ...
        items: [
          ...
          { code: '0201', name: 'อลูมิเneียมกระป๋อง', weight: 4.9, totalAmount: 381.8, avgPrice: 77.92 },
          { code: '0205', name: 'อลูมิเneียมหล่อ', weight: 9.3, totalAmount: 706.8, avgPrice: 76 },
          { code: '0215', name: 'อลูมิเneียมฉาก', weight: 5.6, totalAmount: 560, avgPrice: 100 },
          { code: '0228', name: 'สายไฟอลูมีเneียม(ไม่ปอก)', weight: 3.8, totalAmount: 76, avgPrice: 20 },
      ...
      },
      {
        ...
        items: [
          ...
          { code: '0201', name: 'อลูมิเneียมกระป๋อง', weight: 66.7, totalAmount: 5373.5, avgPrice: 80.56 },
          { code: '0203', name: 'อลูมิเneียมสายไฟ', weight: 1.2, totalAmount: 126, avgPrice: 105 },
          { code: '0204', name: 'อลูมิเneียมบาง', weight: 28.5, totalAmount: 2052, avgPrice: 72 },
          { code: '0205', name: 'อลูมิเneียมหล่อ', weight: 15.7, totalAmount: 1058.1, avgPrice: 67.4 },
          { code: '0213', name: 'อลูมิเneียมฝาแกะ', weight: 1.2, totalAmount: 67.2, avgPrice: 56 },
          { code: '0215', name: 'อลูมิเneียมฉาก', weight: 10.5, totalAmount: 1050, avgPrice: 100 },
          { code: '0221', name: 'อลูมิเneียมอัลลอยด์', weight: 2.2, totalAmount: 105.6, avgPrice: 48 },
          { code: '0231', name: 'อลูมิเneียมฉากสี', weight: 8.4, totalAmount: 747.6, avgPrice: 89 },
      ...
      },
      {
        ...
        items: [
          ...
          { code: '0201', name: 'อลูมิเneียมกระป๋อง', weight: 38.4, totalAmount: 2902, avgPrice: 75.57 },
          { code: '0205', name: 'อลูมิเneียมหล่อ', weight: 73, totalAmount: 4535.2, avgPrice: 62.13 },
          { code: '0210', name: 'อลูมิเneียมตูดกะทะ', weight: 2.8, totalAmount: 121.5, avgPrice: 43.39 },
          { code: '0212', name: 'อลูมิเneียมมู่ลี่', weight: 7.2, totalAmount: 280.8, avgPrice: 39 },
          { code: '0215', name: 'อลูมิเneียมฉาก', weight: 6, totalAmount: 600, avgPrice: 100 },
      ...
      },
      {
        ...
        items: [
          ...
          { code: '0205', name: 'อลูมิเneียมหล่อ', weight: 41, totalAmount: 2987.7, avgPrice: 72.87 },
          { code: '0215', name: 'อลูมิเneียมฉาก', weight: 5, totalAmount: 500, avgPrice: 100 },
    ...
    const SELL_SUMMARY_DATA: Array<{
      ...
      },
      {
        ...
        items: [
          { code: '0201', name: 'อลูมิเneียมกระป๋อง', weight: 770, totalAmount: 65450, avgPrice: 85 },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { code: '0205', name: 'อลูมิเneียมหล่อ', weight: 198.4, totalAmount: 15108, avgPrice: 76.15 },
    ...
    const SELL_DETAIL_DATA: Array<{
      ...
      },
      {
        ...
        items: [
          { code: '0202', name: 'อลูมิเneียมล้อแม็ค', weight: 74.6, pricePerKg: 100.99 },
          { code: '0203', name: 'อลูมิเneียมสายไฟ', weight: 398.4, pricePerKg: 112.26 },
          { code: '0212', name: 'อลูมิเneียมมู่ลี่', weight: 12.6, pricePerKg: 55.87 },
          { code: '0213', name: 'อลูมิเneียมฝาแกะ', weight: 95.6, pricePerKg: 68.42 },
          { code: '0216', name: 'หม้อน้ำอลูมีเneียม', weight: 208.2, pricePerKg: 69.8 },
        ],
      },
      {
        customer: 'ร้าน เอส.เอ็ม.เอ รีไซเคิล (สมพร)', date: '2026-06-24', vehiclePlate: 'A2007607', note: 'หักเต๋า2โล หักเต๋า2โล หักถุงปุ๋ย1.4',
        items: [
          { code: '0215', name: 'อลูมิเneียมฉาก', weight: 964.8, pricePerKg: 1 },
          { code: '0215', name: 'อลูมิเneียมฉาก', weight: 86.6, pricePerKg: 1 },
          { code: '0201', name: 'อลูมิเneียมกระป๋อง', weight: 845, pricePerKg: 85.85 },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          { code: '0205', name: 'อลูมิเneียมแข็ง', weight: 440.6, pricePerKg: 73.26 },
          { code: '0209', name: 'อลูมิเneียมกะทะ', weight: 120, pricePerKg: 62.26 },
          { code: '0210', name: 'อลูมิเneียมตูดกะทะ', weight: 67.8, pricePerKg: 59.91 },
          { code: '0217', name: 'อลูมีเneียมเครื่อง', weight: 131.6, pricePerKg: 89.09 },
          { code: '0221', name: 'อลูมิเneียมอัลลอยด์', weight: 6.2, pricePerKg: 67.74 },
          { code: '0232', name: 'อลูมิเneียมเพลท', weight: 6.7, pricePerKg: 85.25 },

/**
 * ST-17: Inspect sales Excel files to detect format.
 * The files available are: ขาย 2-7-2569 and ขาย 4-7-2569 (as proxy for 9/7)
 */
...
const FILES = [
  ...
  '/home/z/my-project/upload/ขาย 4-7-2569 แบบละเอียด.xls',
]

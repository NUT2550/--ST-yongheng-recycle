/**
 * ST-75 Phase 2: PGlite synthetic SQL microbenchmark (NOT production-path).
 *
 * Uses PGlite (WASM PostgreSQL) for synthetic SQL microbenchmark.
 * This is NOT production-path evidence — uses simulated bill creation, not real services.
 * Production-path evidence is in tests/st75-import-postgres-production-path.test.ts.
